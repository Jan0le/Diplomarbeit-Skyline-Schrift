...
\section{Grundlagen automatisierter Datenuebernahme}
...
und in die Flugverwaltung uebernommen.
...
\section{Datenquellen fuer Flugdaten}
...
Kernfelder sind Abflug-/Zielairport, Flugnummer und Datum. Diese reichen fuer
...
Nach OCR muessen Texte geparst und relevanten Feldern zugeordnet werden
...
Parsing erfolgt ueber definierte Regeln und Feldmuster. Ziel ist ein robustes
...
Er darf keine falschen Daten unbemerkt uebernehmen.
...
Automatisierung ermoeglicht das Verarbeiten vieler Fluege ohne Zusatzaufwand.
\section{Ergebnis}
...
Nutzer koennen Fluege schneller erfassen und frueher mit Planung starten.

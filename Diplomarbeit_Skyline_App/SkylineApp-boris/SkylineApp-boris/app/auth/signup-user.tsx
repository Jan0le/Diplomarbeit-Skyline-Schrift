      ...
      >
        ...
        >
          ...
          >
            ...
            <Text style={styles.subtitle}>Start tracking your flights today</Text>
          </Animated.View>
...
const styles = StyleSheet.create({
  ...
  eyeButton: { padding: 8 },
  termsText: { fontSize: 11, color: 'rgba(255, 255, 255, 0.5)', textAlign: 'center', marginBottom: 12, lineHeight: 16 },
  termsLink: { color: '#ff1900', fontWeight: '600' },

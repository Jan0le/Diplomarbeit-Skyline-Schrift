...
% BCBP-Struktur: Aus IATA Implementation Guide S.\,49 ff.\ oder
% \url{https://slideplayer.com/slide/12543027/} herunterladen und als bcbp_structure.png in content/img/ ablegen.
\IfFileExists{content/img/bcbp_structure.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{bcbp_structure}
  \caption{BCBP Feldstruktur (Übersicht). \cite{slideplayerBCBP}}
...
\IfFileExists{content/img/ocr_pipeline.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{ocr_pipeline}

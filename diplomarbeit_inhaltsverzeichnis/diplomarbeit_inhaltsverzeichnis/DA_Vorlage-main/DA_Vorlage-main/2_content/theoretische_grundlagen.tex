...
\begin{figure}[H]
  ...
  \caption{BCBP Feldstruktur (Übersicht). Quelle: SlidePlayer -- JCAA Aviation Seminar, BCBP Data Field Structure.}
...
\begin{figure}[H]
  ...
  \caption{OCR-Prozess (Pipeline). Quelle: TheAILearner -- Optical Character Recognition Pipeline.}
...
% Great Circle: \url{https://gisgeography.com} (Great-Circle-Shortest-Flight-Path.png) herunterladen und als great_circle_route.png in content/img/ ablegen.
\IfFileExists{content/img/great_circle_route.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{great_circle_route}
  \caption{Great Circle Route vs.\ gerade Linie: die kürzeste Flugstrecke. Quelle: GIS Geography.}
  \label{fig:great_circle_route}
\end{figure}%
}{}
...
% Haversine-Skizze: \url{https://sketchplanations.com/the-haversine-formula} herunterladen und als haversine_sketch.png in content/img/ ablegen.
\IfFileExists{content/img/haversine_sketch.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{haversine_sketch}
  \caption{Haversine-Formel visuell. Quelle: Sketchplanations.}

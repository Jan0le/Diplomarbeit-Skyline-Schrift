...
Skyline wurde als \textbf{native iOS-App} entwickelt und ist im
\textbf{Apple App Store} verfügbar.
...
\begin{itemize}
  \item \textbf{Weltkarte:} Wie sehr steigert eine visuelle Darstellung
  ...
  \item \textbf{Benachrichtigungen:} Wie sehr erhöhen proaktive
  Benachrichtigungen die Zuverlässigkeit und Effizienz bei der Reiseorganisation?
  \item \textbf{Datenverwaltung:} In welchem Maße verbessert eine

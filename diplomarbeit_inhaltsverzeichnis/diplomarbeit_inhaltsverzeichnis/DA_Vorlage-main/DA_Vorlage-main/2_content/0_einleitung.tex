...
Statistiken und Erinnerungen.
Skyline wurde mit \textbf{React Native} und \textbf{Expo} als mobile App umgesetzt, primär für \textbf{iOS} entwickelt und ist im \textbf{Apple App Store} verfügbar.
Die Arbeit dokumentiert die Implementierung strukturiert und bewertet die Wirkung
in Bezug auf Zuverlässigkeit, Effizienz, Transparenz und Nachvollziehbarkeit.
...
Grundlagen (Import, Karten, Benachrichtigungen, Datenverwaltung). Kapitel~4 beschreibt
die Systemarchitektur und technische Übersicht von Skyline (Flugverwaltung, Dokumente,
Notizen, Checklisten, Statistiken, Company-Features, Gamification, Teststrategie).
Kapitel~5 bis~8 dokumentieren die Implementierung der vier Forschungsmodule (Import,
Datenverwaltung, Weltkarte, Benachrichtigungen). Kapitel~9 fasst Bewertung und
Evaluation zusammen. Kapitel~10 enthält die Installation, Kapitel~11 schließt mit

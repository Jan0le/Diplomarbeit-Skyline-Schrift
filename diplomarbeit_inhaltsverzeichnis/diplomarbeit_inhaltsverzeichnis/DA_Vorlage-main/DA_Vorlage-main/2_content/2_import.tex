...
Dieses Kapitel beschreibt die Umsetzung des automatischen Imports in Skyline. Die theoretischen Grundlagen (Datenquellen, Validierung, Fehlerbehandlung) werden in Kapitel 3 behandelt. Da Skyline primär als iOS-App entwickelt wurde, nutzen alle Import-Funktionen die nativen iOS-APIs (Kamera, Fotoauswahl, Datei-Picker) über die jeweiligen Expo-Module.

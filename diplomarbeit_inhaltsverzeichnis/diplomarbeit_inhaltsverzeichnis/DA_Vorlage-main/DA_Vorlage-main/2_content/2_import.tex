...
\textbf{Flug-Import (QR/OCR/Datei):} Der \emph{Add-Flight-Import}-Flow (\texttt{add-flight-import.tsx}) bietet die drei Wege zum Anlegen eines \emph{neuen} Flugs: Scan eines Boardingpasses mit der Kamera, Import eines PDFs oder Bilds aus dem Dateidialog sowie Auswahl eines Screenshots aus der Galerie. Die Datei wird per OCR ausgewertet, Flugdaten extrahiert und nach Validierung als neuer Flug gespeichert.

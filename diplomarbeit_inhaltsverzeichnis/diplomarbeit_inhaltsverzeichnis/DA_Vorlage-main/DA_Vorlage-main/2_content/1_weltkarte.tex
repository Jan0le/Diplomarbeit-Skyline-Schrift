...
\chapter{Implementierung: Interaktive Weltkarte \& Routenvisualisierung}\label{chapter:weltkarte}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{fehlende_bilder/map/image}
...
% ------------------------------------------------------------
\subsection{History vs.\ Upcoming-Fl\"uge und Sortierung}
...
Durch diese Status-Sortierung und die Fokussierungsfunktionen (Marker-Tap, \glqq Show Flight Path\grqq{},
\glqq Show Live Flight\grqq{}) bleibt die Übersicht auch bei vielen gespeicherten Reisen gut nutzbar,
ohne dass zusätzliche Filter in der Flug-Historie implementiert werden mussten.
...
Die Kartenlösung in Skyline wird entlang von vier Bewertungsdimensionen betrachtet:
Übersichtlichkeit, räumliche Korrektheit, Interaktivität und Fehlerrobustheit;
es handelt sich dabei um inhaltliche Aspekte der Analyse und nicht um eine räumliche
3D-Darstellung.

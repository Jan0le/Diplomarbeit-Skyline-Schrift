...
Effizienz, Transparenz, Nachvollziehbarkeit und Nutzerakzeptanz. KPIs und qualitative
Kriterien wurden pro Modul angewendet, um die Wirkung messbar zu machen; diese Kriterien
bilden die inhaltlichen Bewertungsdimensionen der Arbeit und sind nicht als räumliche
3D-Darstellung zu verstehen. Je nach Modul werden sie unterschiedlich konkretisiert --
beispielsweise erscheint Transparenz bei der Weltkarte als Übersichtlichkeit, bei der
Datenverwaltung als Status-Sichtbarkeit.
...
\ref{chapter:import} beschreibt die Implementierung von QR-Scan, OCR und dokumentenbasiertem
Import (z.\,B.\ aus exportierten E-Mail-PDFs oder Screenshots).
Ein direkter, automatischer Zugriff auf E-Mail-Postfächer wurde im aktuellen Stand nicht
umgesetzt, sondern nur konzeptionell vorbereitet.
Die automatische Erfassung reduziert den manuellen Aufwand dennoch erheblich; Nutzer können
Flüge in Sekunden statt Minuten erfassen.
Die Bewertung dokumentiert die Zeitersparnis gegenüber manueller Eingabe.
